...
```bash
hyperfine --warmup 1 --runs 5 \
  'mkbrr create The.Show.S02.1080p.DSNP.WEB-DL.DDP5.1.H.264-FLUX --workers 64' \
  'mktorrent -l 24 The.Show.S02.1080p.DSNP.WEB-DL.DDP5.1.H.264-FLUX' \
  'torrenttools create --threads 64 The.Show.S02.1080p.DSNP.WEB-DL.DDP5.1.H.264-FLUX' \
  'torf --threads 64 The.Show.S02.1080p.DSNP.WEB-DL.DDP5.1.H.264-FLUX'
```
