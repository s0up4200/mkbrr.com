...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', marginTop: '-2rem' }}>
  ...
  <div style={{ flex: '0 0 auto' }}>
    <img noZoom className="block h-24 dark:hidden" src="/images/mkbrr-light.png" onContextMenu={(e) => e.preventDefault()} draggable="false" />
    <img noZoom className="hidden h-24 dark:block" src="/images/mkbrr-dark.png" onContextMenu={(e) => e.preventDefault()} draggable="false" />
  </div>
</div>
