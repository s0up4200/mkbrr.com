...
default:
  private: true      # Default to private torrents
  no_date: true      # Don't write creation date by default
  no_creator: false  # Write creator string by default
  skip_prefix: false # Add tracker prefix to filename by default
  # comment: "Default comment"
  # source: "DEFAULT_SRC"
  # exclude_patterns: ["*.bak", "temp.*"]
  # include_patterns: ["*.mkv", "*.mp4"]
  # piece_length: 20 # Default piece length exponent (1 MiB) if set

presets:
  # Name of the preset (used with -P flag)
  preset-name-1:
    trackers:
  ...
  preset-name-2:
    ...
    private: false # Make this preset public
